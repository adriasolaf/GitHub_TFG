function [ r_ijk, v_ijk ] = KEP2ICF_O ( sma, ecc, inc, nu, argp, raan, mu )
...
%
% Inputs:
%   sma: semi-major axis [km], or semi-latus rectum (p) [km] if parabola
%   ecc: eccentricity [#]
%   inc: inclination [rad]
%   nu: true anomaly [rad]
...
if ecc~=1, p = sma * (1.0 - ecc*ecc); % Ellipse, Hyperbola
